...
import com.loonycorn.aopadvice.Order;
...
public class AspectConfig54 {
    ...
    @Around("execution(* com.loonycorn.aopadvice.Order.displayOrderItems())")
    ...
    @After("execution(* com.loonycorn.aopadvice.Order.displayOrderItems())")
    ...
    @AfterThrowing(pointcut = "execution(* com.loonycorn.aopadvice.Order.*(..))", throwing="ex")
    ...
    @AfterReturning(pointcut = "execution(* com.loonycorn.aopadvice.Order.displayOrderItems())")
